...
def render():
    ...
    v4=load_json_safe(str(TRENDYOL_RELEVANCE_DIR/"outputs/v4/v4_results.json"));comparison_cards([{"title":"V4 End-to-End Search Pipeline","status":"Araştırma","kind":"experimental","algorithm":"Hybrid retrieval · fusion · optional V1 · isolated ranking","metric":"Recall@50 0.8346 · fixed RRF k=20","note":f"{v4.get('selected_policy','Hybrid retrieval-only')} · fallback-safe · Not Production Promoted."}])
    architecture_flow([("Query","current"),("Retrieval","experimental"),("Fusion","experimental"),("Relevance","current"),("Ranking","experimental"),("Results","experimental")])
    cols=st.columns(2)
    ...
    groups={"Data Engineering":"Schema validation · profiling · deterministic sampling · quality checks · feature pipelines","Machine Learning":"Logistic Regression · LinearSVC · Random Forest · boosting · calibration · classification metrics","NLP & Search":"Word/character TF-IDF · multilingual embeddings · hybrid retrieval · relevance · learning to rank (Experimental)","Model Operations":"Persisted pipelines · registry · checksum · reload · batch inference","Responsible Evaluation":"Leakage prevention · holdout · bootstrap CI · limitation reporting","Next":"Compatible reranker research · online evaluation only after governance approval (Planned)"}
